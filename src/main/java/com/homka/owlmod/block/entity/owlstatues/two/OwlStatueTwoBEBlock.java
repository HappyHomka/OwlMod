...
public class OwlStatueTwoBEBlock extends Block implements BlockEntityProvider {
    ...
    *
    ...
    public OwlStatueTwoBEBlock(Settings settings) {
        super(settings);
    }

    @Override
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return ModBlockEntities.OWL_STATUE_TWO.instantiate(pos,state);
    }
    ...
    *
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if(blockEntity instanceof OwlStatueTwoBlockEntity StatueBE && player != null){
            if(StatueBE.is_ready()){
                ...
                world.playSound(null,pos, ModSounds.OWL_STATUE_USE_TWO, SoundCategory.BLOCKS,0.02f, pitch);
